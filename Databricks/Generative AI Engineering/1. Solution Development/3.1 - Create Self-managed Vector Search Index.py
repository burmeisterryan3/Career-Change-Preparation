...
#
# In this demo, we will go with the first method. 
#
...
#
# **💡 Note: In the code block below, `create_endpoint` function is commented out. If you have right permissions, you can create an endpoint using that function.**
