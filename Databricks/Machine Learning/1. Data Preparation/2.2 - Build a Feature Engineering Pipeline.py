...
# Get a list of columns with missing values - String
...
imputer = Imputer(inputCols=to_impute, outputCols=to_impute, strategy='mean')
...
# OHE categoricals - output is a sparse representation
...
# Sparse format = (length, non-zero feature indices, non-zero feature values)
