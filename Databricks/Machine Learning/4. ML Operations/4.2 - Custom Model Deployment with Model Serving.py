...
# Not sure what the below cell is doing... we just did this all (more comprehensively) above
...
# [mlflow.pyfunc.PythonModel](https://mlflow.org/docs/latest/python_api/mlflow.pyfunc.html#mlflow.pyfunc.PythonModel)
#
# NOTE: - The model below is generic, but we will instatiate a `sklearn.tree.DecisionTreeClassifier` below.
#
# [sklearn.tree.DecisionTreeClassifier.predict](https://scikit-learn.org/stable/modules/generated/sklearn.tree.DecisionTreeClassifier.html#sklearn.tree.DecisionTreeClassifier.predict)
#
# [sklearn.tree.DecisionTreeClassifier.predict_proba](https://scikit-learn.org/stable/modules/generated/sklearn.tree.DecisionTreeClassifier.html#sklearn.tree.DecisionTreeClassifier.predict_proba) 
...
class CustomProbaModel(mlflow.pyfunc.PythonModel):
    ...
    # Prediction function
    # Note sure why context is used here... need to look at further examples
...
# See 4.1 for other method defintiions from `mlflow`.
...
output_example = wrapped_model.predict([],X_train[:1]) # empty list = context... not used in predict method of CustomProbaModel
