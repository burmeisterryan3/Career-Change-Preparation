...
Person bob = new();
bob.Name = "Bob Smith";
bob.DateOfBirth = new DateTime(1965, 12, 22); // see below for more concise syntax
...
// to match textbook, which is in pounds
// Thread.CurrentThread.CurrentCulture = System.Globalization.CultureInfo.GetCultureInfo("en-GB");

BankAcount.InterestRate = 0.012M; // store a shared value

// Constructors
BankAcount jonesAccount = new();
jonesAccount.AccountName = "Mrs.Jones";
jonesAccount.Balance = 2400;
WriteLine(format: "{0} earned {1:C} interest.",
    arg0: jonesAccount.AccountName,
    arg1: jonesAccount.Balance*BankAcount.InterestRate);

BankAcount gerrierAccount = new();
gerrierAccount.AccountName = "Ms.Gerrier";
gerrierAccount.Balance = 98;
WriteLine(format: "{0} earned {1:C} interest.",
    arg0: gerrierAccount.AccountName,
    arg1: gerrierAccount.Balance * BankAcount.InterestRate);
...
lamech.Marry(adah);
// Person.Marry(zillah, lamech); // because of implementation - order matters
if (zillah + lamech) WriteLine($"{zillah.Name} and {lamech.Name} successfully got married.");
...
// call static method
Person baby2 = Person.Procreate(zillah, lamech); // because of implementation, order matters
