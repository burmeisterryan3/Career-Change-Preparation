...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    with open(dogfile, "r") as infile:
        ...
        while line != "":
            ...
            # If line is not in dognames_dic then adds it to dognames_dic
    ...
    for key in results_dic:
        ...
        if results_dic[key][0] in dognames_dic:
            # whether(1) or not(0) pet image label is a dog
            results_dic[key].append(1)
        else:
            # whether(1) or not(0) pet image label is a dog
            results_dic[key].append(0)
        
        # Classifier Label IS of Dog (e.g. found in dognames_dic)
        if results_dic[key][1] in dognames_dic:
            # whether(1) or not(0) classifier label is a dog
            results_dic[key].append(1)
        else:
            # whether(1) or not(0) classifier label is a dog
            results_dic[key].append(0)
        
    return None # results_dic is a mutable data type, so no return needed
